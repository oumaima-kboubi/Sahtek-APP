...
(function ($) {
  ...
  try {
    ...
    // Recent Report
    const brandProduct = 'rgba(37,195,190)'
    const brandService = 'rgba(46,155,216)'

    var elements = 12
    var data1 = [0, 0, 0, 0, 125, 105, 0, 0, 0, 0, 0, 0]
    var data2 = [0, 0, 0, 4, 2, 3, 0, 0, 0, 0, 0, 0]
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          datasets: [
            {
              label: "My First dataset",
              data: [entryInfoObjects[0]['pend'], entryInfoObjects[0]['refuse'], entryInfoObjects[0]['accept']],
              backgroundColor: [
                '#00b5e9',
                '#fa4251',
                '#72d8a1'
